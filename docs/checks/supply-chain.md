...
KubeVigil includes 6 checks that detect supply chain security risks and container lifecycle concerns, covering container runtime socket access, health probes, lifecycle hooks, and image freshness.
