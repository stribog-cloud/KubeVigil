...
**Reference document:** `docs/internal/kubevigil-features-v2.md` contains the complete feature specification across all 7 phases. **Read this file before making architectural decisions.** It defines all 112 security checks, testing strategy, compliance frameworks, output formats, and roadmap.
...
- **Read `docs/internal/kubevigil-features-v2.md`** for detailed check descriptions, severity rationale, and edge cases. This CLAUDE.md has check IDs and severities but the features doc has the full behavioral specification.
