...
var mitreMappingData = map[string][]checker.FrameworkRef{
	...
	"service-externalname-dangling":            {mitre("T1584.001", "T1584.001")},
	...
	"webhook-external-url":                     {mitre("T1557", "T1557")},
	"apiservice-insecure-skip-verify":          {mitre("T1557", "T1557")},
	"host-users-not-isolated":                  {mitre("T1611", "Escape to Host")},
	"windows-hostprocess":                      {mitre("T1611", "Escape to Host")},
	"hostaliases-injection":                    {mitre("T1584.001", "T1584.001")},
	"serviceaccount-token-manual-volume-mount": {mitre("T1528", "Steal Application Access Token")},
	"subpath-symlink-risk":                     {mitre("T1611", "T1611")},
	"priority-class-excessive-value":           {mitre("T1499", "T1499")},
	"serviceaccount-token-secret-legacy":       {mitre("T1528", "T1528")},
	"secrets-in-annotations":                   {mitre("T1552", "Unsecured Credentials")},
	"poststart-hook-network-call":              {mitre("T1071", "T1071")},
}
