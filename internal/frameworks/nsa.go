...
var nsaMappingData = map[string][]checker.FrameworkRef{
	...
	"rbac-csr-approval":                        {nsa("3.1", "3.1")},
	"rbac-webhook-tampering":                   {nsa("2.1", "Pod security enforcement")},
	"rbac-token-request":                       {nsa("3.1", "3.1")},
	"rbac-crossnamespace-serviceaccount":       {nsa("3.1", "3.1")},
	"rbac-deletecollection-broad":              {nsa("3.1", "3.1")},
	"rbac-aggregation-label-injection":         {nsa("3.1", "3.1")},
	"validatingwebhook-failure-policy-ignore":  {nsa("2.1", "2.1")},
	"mutatingwebhook-wildcard-scope":           {nsa("2.1", "2.1")},
	"windows-hostprocess":                      {nsa("1.1", "1.1")},
	"serviceaccount-token-manual-volume-mount": {nsa("3.1", "3.1")},
	"csi-inline-ephemeral-volume":              {nsa("1.3", "minimized host resource access")},
	"serviceaccount-token-secret-legacy":       {nsa("3.1", "3.1")},
}
