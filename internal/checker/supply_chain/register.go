...
//
// It covers 6 checks spanning container runtime socket exposure, liveness/readiness/startup
// probe configuration, preStop and postStart lifecycle hooks, and image age staleness.
...
func init() {
	...
	checker.MustRegister(&PostStartHookNetworkCallChecker{})
}
