...
var defaultSeverities = map[string]string{
	...
	"rbac-node-proxy-access":                   "Critical",
	"rbac-csr-approval":                        "Critical",
	"rbac-webhook-tampering":                   "High",
	"rbac-token-request":                       "Critical",
	"rbac-crossnamespace-serviceaccount":       "Medium",
	"rbac-deletecollection-broad":              "High",
	"rbac-aggregation-label-injection":         "High",
	"gateway-listener-no-tls":                  "High",
	"gateway-allowedroutes-all-namespaces":     "Medium",
	"httproute-wildcard-hostname":              "Medium",
	"network-policy-empty-namespace-selector":  "Medium",
	"service-externalname-dangling":            "Medium",
	"metadata-service-egress-unblocked":        "High",
	"validatingwebhook-failure-policy-ignore":  "High",
	"mutatingwebhook-wildcard-scope":           "High",
	"validatingadmissionpolicy-audit-only":     "Medium",
	"webhook-external-url":                     "High",
	"apiservice-insecure-skip-verify":          "High",
	"crd-preserve-unknown-fields":              "Medium",
	"crd-status-subresource-missing":           "Medium",
	"crd-multiversion-no-conversion":           "Medium",
	"host-users-not-isolated":                  "Low",
	"windows-hostprocess":                      "Critical",
	"termination-grace-period-zero":            "Low",
	"hostaliases-injection":                    "Medium",
	"ephemeral-storage-requests-missing":       "Low",
	"serviceaccount-token-manual-volume-mount": "Medium",
	"subpath-symlink-risk":                     "Low",
	"csi-inline-ephemeral-volume":              "Medium",
	"generic-ephemeral-volume-no-limits":       "Low",
	"volumesnapshotclass-no-encryption":        "Medium",
	"job-active-deadline-missing":              "Low",
	"priority-class-excessive-value":           "Medium",
	"cronjob-concurrency-unbounded":            "Low",
	"secrets-immutable-missing":                "Low",
	"secrets-envfrom-bulk":                     "High",
	"serviceaccount-token-secret-legacy":       "Medium",
	"secrets-tls-weak-key":                     "Medium",
	"secrets-in-annotations":                   "High",
	"poststart-hook-network-call":              "Low",
}
